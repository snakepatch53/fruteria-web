...
export default function CrudProgress({ isOpen }) {
    return (
        <section
            className={cls(
                "fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-black/10 w-full h-full opacity-0 max-w-0 max-h-0 overflow-hidden transition-all duration-300 ease-in-out",
                {
